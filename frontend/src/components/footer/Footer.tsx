import { Box, Grid2, Typography, Link, Divider } from "@mui/material";
import HeaderLogo from "../header/HeaderLogo";

function Footer() {
  return (
    <Box sx={{ backgroundColor: "#111", color: "#fff", padding: "2rem 1rem" }}>
      {/* Main Footer Content */}
      ...
      {/* Certifications */}
      <Box
        sx={{ display: "flex", justifyContent: "space-around", margin: "2rem 0", flexWrap: "wrap" }}
      >
        <img
